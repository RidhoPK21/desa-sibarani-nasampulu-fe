    ...
    >
      <div className="px-6 py-4 max-w-7xl mx-auto flex justify-between items-center">
        ...
        >
          ...
          <div className="flex flex-col">
            ...
            <span className="text-xs font-medium" style={{ color: "#e8f5e9" }}>
              Kab. Toba Samosir
            </span>
          </div>
        </Link>
      ...
      {isOpen && (
        <div className="lg:hidden bg-[#4EA674] px-4 pt-2 pb-4 space-y-1 border-t border-[#3b865d]">
          ...
          <Link
            to="/infografis"
            style={getMobileStyle("/infografis")}
            onClick={closeMenu}
            className="block px-3 py-2 rounded-md text-base"
          >
            Infografis
          ...
          <Link
            to="/dokumentasi"
            style={getMobileStyle("/dokumentasi")}
            onClick={closeMenu}
            className="block px-3 py-2 rounded-md text-base"
          >
            Dokumentasi
